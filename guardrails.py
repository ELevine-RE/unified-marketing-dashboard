...
class PerformanceMaxGuardrails:
    ...
    def __init__(self):
        """Initialize guardrails with safety thresholds."""
        # Budget guardrails
        self.BUDGET_LIMITS = {
            'min_daily': 30.0,
            'max_daily': 100.0,
        ...
        self.GEO_TARGETING_LIMITS = {
            ...
            'period_days': 21  # Conservative 21 days
        }
        
        # URL exclusions required
        self.REQUIRED_URL_EXCLUSIONS = [
            '/buyers/*',
            '/sellers/*',
            '/featured-listings/*',
            '/contact/*',
        ...
        # Change window and frequency controls
        self.CHANGE_WINDOW_HOURS = 2
        self.ONE_LEVER_PER_WEEK_DAYS = 7
    ...
    def enforce_guardrails(self, change_request: Dict, campaign_state: Dict) -> GuardrailVerdict:
        ...
        Acceptance Criteria:
        - Budget changes: ±20-30% per change, ≥7d since last change, min $30/day, max $100/day
        - tCPA changes: only if ≥30 conversions, ±10-15% per change, ≥14d since last change, $80-$200
